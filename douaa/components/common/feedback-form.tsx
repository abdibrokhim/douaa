...
export function FeedbackForm({ authUserId, onClose }: FeedbackFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const subject = encodeURIComponent("Feedback for Douaa Chat")
      const body = encodeURIComponent(feedback)
      const userId = authUserId ? encodeURIComponent(`User ID: ${authUserId}`) : "Douaa User"
        ...
        {status === "success" ? (
          ...
          >
            ...
            <p className="text-muted-foreground text-sm">
              Your feedback makes Douaa better.
            </p>
          </motion.div>
        ) : (
          <motion.form
          ...
          >
            ...
            >
              What would make Douaa better for you?
            </motion.span>
            <textarea
